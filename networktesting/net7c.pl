...
<td>View error log
(<A HREF="javascript:void(0)"onclick="window.open('/cgi-bin/netlog.pl?10','netlog','width=600,height=300')">10</A>,
<A HREF="javascript:void(0)"onclick="window.open('/cgi-bin/netlog.pl?20','netlog','width=600,height=300')">20</A> or
<A HREF="javascript:void(0)"onclick="window.open('/cgi-bin/netlog.pl?30','netlog','width=600,height=300')">30</A> lines.)
